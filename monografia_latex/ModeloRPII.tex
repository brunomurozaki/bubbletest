...
%-------------------------------------------------------------------------
\begin{siglas}
  \item[WEB] Termo referente à World Wide Web, geralmente referido como sinônimo de internet;
  \item[REST] Acrônimo para Representational State Transfer. Arquitetura para servidores \textit{web};
...
Através destas \textit{tags} foi possível inferir o posicionamento político de cada uma das páginas. A tabela \ref{tabelaTags} demonstra como foi feita a relação entre as tags existentes e o posicionamento político de cada uma.  
